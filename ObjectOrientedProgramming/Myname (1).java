...
public class Myname {
    ...
    public static void main(String[] args) {
        ...
        Myname alias = new Myname("James do Bond", 55, "Secret Agent", "Alamo Street", 555555, "007neverdies@time.com",
                ...
                System.out.println("His Age is: " + alias.getAge());
                System.out.println("His job is: " + alias.getJob());
                System.out.println("Address: " + alias.getAddress());
                System.out.println("The Phone Number: " + alias.getPhonenumber());
                System.out.println("Email: " + alias.getEmail());
                System.out.println("Does it have a car: " + alias.getCar());
                System.out.println("Incoming Salary: $" + alias.getIncome());
